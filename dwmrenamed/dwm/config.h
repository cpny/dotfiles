...
static const char colors[NUMCOLORS][ColLast][13] = {
    /* border    fg         bg */
    { "#170F0D", "#FFFFFF", "#170F0D" },        /* 01 - regular */
    { "#7B854E", "#FFFFFF", "#170F0D" },        /* 02 - selected */
    { "#2D2D2D", "#FF0000", "#170F0D" },        /* 03 - urgent */
    { "#2D2D2D", "#666666", "#170F0D" },        /* 04 - occupied */
    { "#2D2D2D", "#A82222", "#170F0D" },        /* 05 - red */
    { "#170F0D", "#746C48", "#170F0D" },        /* 06 - blue */
    { "#2D2D2D", "#349147", "#170F0D" },        /* 07 - green */
    { "#170F0D", "#170F0D", "#170F0D" },        /* 08 - dark grey */
    { "#2D2D2D", "#DCDCDC", "#170F0D" },        /* 09 - light grey */
    { "#2D2D2D", "#7B854E", "#170F0D" },        /* 0A - orange */
    { "#2D2D2D", "#B86A6A", "#170F0D" },        /* 0B - pink */
    { "#2D2D2D", "#FFFFFF", "#170F0D" },        /* 0C - white */
    { "#2D2D2D", "#000000", "#170F0D" },        /* 0D - black */
};
...
static const char *webb[] = { "firefox", NULL, "Dwb" };
static const char *file[] = { "pcmanfm", NULL, "Pcmanfm" };
static const char *term[] = { "urxvt", NULL,  };
static const char   *mailcmd[] = { "urxvt", "--name=mutt", "-e", "mutt", NULL };
static const char   *tmuxcmd[] = { "urxvt", "--name=tmux", "-e", "tmux", NULL };
static const char   *yt[] = { "urxvt", "--name=YouTube", "-e", "youtube-viewer", NULL };
